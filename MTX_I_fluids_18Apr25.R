...
a3 <- a1 - (data[6,5] + data[7,5] + data[8,5] + data[9,5] + data[13,5] + data[14,5] + data[15,5] + data[16,5] +
              data[22,5] + data[23,5] + data[24,5] + data[25,5] + data[29,5] + data[30,5] + data[31,5] + data[32,5] +
              data[38,5] + data[39,5] + data[40,5] + data[41,5] + data[45,5] + data[46,5] + data[47,5] + data[48,5]) #subtracting those that go to end before 42hr / Q4
a4 <- a3 #42hr fluid
a5 <- a3 - (data[54,5] + data[55,5] + data[56,5] + data[57,5] + data[61,5] + data[62,5] + data[63,5] + data[64,5]) #subtracting those that go to end before 48hr
a6 <- a5 #48hr fluid
a7 <- a5 - (data[69,5] + data[70,5] + data[71,5] + data[72,5] + data[75,5] + data[76,5] + data[77,5] + data[67,5]) #subtracting those that go to end before 54hr
a8 <- a7 #54hr fluid
a9 <- a7 - (data[82,5] + data[83,5] + data[84,5] + data[85,5] + data[87,5] + data[88,5] + data[89,5] + data[90,5]) #subtracting those that go to end before 60hr
a10 <- a9
a11 <- a9 - (data[93,5] + data[94,5] + data[85,5] + data[96,5] + data[97,5]) #subtracting those that go to end before Finish
...
a3.soc <- a1.soc - (data[6,7] + data[7,7] + data[8,7] + data[9,7] + data[13,7] + data[14,7] + data[15,7] + data[16,7] +
              data[22,7] + data[23,7] + data[24,7] + data[25,7] + data[29,7] + data[30,7] + data[31,7] + data[32,7] +
              data[38,7] + data[39,7] + data[40,7] + data[41,7] + data[45,7] + data[46,7] + data[47,7] + data[48,7]) #subtracting those that go to end before 42hr / Q4
a4.soc <- a3.soc #42hr fluid
a5.soc <- a3.soc - (data[54,7] + data[55,7] + data[56,7] + data[57,7] + data[61,7] + data[62,7] + data[63,7] + data[64,7]) #subtracting those that go to end before 48hr
a6.soc <- a5.soc #48hr fluid
a7.soc <- a5.soc - (data[69,7] + data[70,7] + data[71,7] + data[72,7] + data[75,7] + data[76,7] + data[77,7] + data[67,7]) #subtracting those that go to end before 54hr
a8.soc <- a7.soc #54hr fluid
a9.soc <- a7.soc - (data[82,7] + data[83,7] + data[84,7] + data[85,7] + data[87,7] + data[88,7] + data[89,7] + data[90,7]) #subtracting those that go to end before 60hr
a10.soc <- a9.soc
a11.soc <- a9.soc - (data[93,7] + data[94,7] + data[85,7] + data[96,7] + data[97,7]) #subtracting those that go to end before Finish

a1.mtx <- (data[1,9] + data[2,9]) #24
a2.mtx <- a1.mtx  #24fluid
a3.mtx <- a1.mtx - (data[6,9] + data[7,9] + data[8,9] + data[9,9] + data[13,9] + data[14,9] + data[15,9] + data[16,9] +
                  data[22,9] + data[23,9] + data[24,9] + data[25,9] + data[29,9] + data[30,9] + data[31,9] + data[32,9] +
                  data[38,9] + data[39,9] + data[40,9] + data[41,9] + data[45,9] + data[46,9] + data[47,9] + data[48,9]) #subtracting those that go to end before 42hr / Q4
a4.mtx <- a3.mtx #42hr fluid
a5.mtx <- a3.mtx - (data[54,9] + data[55,9] + data[56,9] + data[57,9] + data[61,9] + data[62,9] + data[63,9] + data[64,9]) #subtracting those that go to end before 48hr
a6.mtx <- a5.mtx #48hr fluid
a7.mtx <- a5.mtx - (data[69,9] + data[70,9] + data[71,9] + data[72,9] + data[75,9] + data[76,9] + data[77,9] + data[67,9]) #subtracting those that go to end before 54hr
a8.mtx <- a7.mtx #54hr fluid
a9.mtx <- a7.mtx - (data[82,9] + data[83,9] + data[84,9] + data[85,9] + data[87,9] + data[88,9] + data[89,9] + data[90,9]) #subtracting those that go to end before 60hr
a10.mtx <- a9.mtx
a11.mtx <- a9.mtx - (data[93,9] + data[94,9] + data[85,9] + data[96,9] + data[97,9]) #subtracting those that go to end before Finish
